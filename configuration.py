...
class Configurations:
	...
	def readConfigurations(self,uid):
		self.currdir = os.path.dirname(os.path.abspath(__file__))
		with open(self.currdir + "/stickies.cfg",'a'):
			self.config.read(path.join(self.currdir,"stickies.cfg"))
	...
	def writeConfigurations(self,uid,preferences=None):
		...
		with open(path.join(self.currdir,"stickies.cfg"),"wb+") as configfile:
